...
/**
 * BVIPSerialPort Klasse implementiert einen Splitter für den seriellen Anschluss.
 * Erweitert BVIPBase.
 *
 * @author        Michael Tröger <micha@nall-chan.net>
 * @copyright     2020 Michael Tröger
...
class BVIPSerialPort extends BVIPBase
{
    ...
    protected function ConfigAndOpenPort()
    {
        ...
        /* @var $RCPReplyData RCPData */
        if ($RCPReplyData->Error != RCPError::RCP_ERROR_NO_ERROR) {
            if (($RCPReplyData->Error != RCPError::RCP_ERROR_SEND_ERROR) && ($RCPReplyData->Error != RCPError::RCP_ERROR_NO_ERROR)) {
